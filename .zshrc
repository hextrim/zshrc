...
export PATH=/usr/local/aws/bin:/usr/local/opt/helm@2/bin:$PATH
...
export ZSH="/Users/lo3k/.oh-my-zsh"
...
POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX="%{%F{blue}%}\u2517%{%F{yellow}%}\uF460%{%F{white}%} "
...
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=('kubecontext' 'virtualenv' 'load' 'ram_joined' 'time')
...
alias vi="vim"
alias k="kubectl"
alias s='_ssh(){ssh ubuntu@$1;}; _ssh'
alias w='_ssh(){ssh wojciech.orlowski@$1;}; _ssh' 
